...
#include "Log.h"
using namespace std;
bool LoginStub::PacketProcReqLogin(SessionInfo sessionInfo, CRecvBuffer& buf)
{
	INT64 accountNo;
...
bool LoginStub::PacketProcResLogin(SessionInfo sessionInfo, CRecvBuffer& buf)
{
	INT64 accountNo;
	BYTE status;
	Array<WCHAR,20> id;
...
bool LoginStub::PacketProc(SessionInfo sessionInfo, CRecvBuffer& buf)
{
	short packetType;
	try
	{
